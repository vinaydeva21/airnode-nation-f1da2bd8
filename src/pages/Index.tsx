    ...
    <NetworkBackground>
      ...
      <section className="pt-24 pb-20 px-4">
        <div className="container mx-auto text-center">
          ...
          <h1 className="text-4xl md:text-6xl font-bold bg-gradient-to-r from-white to-gray-300 text-transparent bg-clip-text mb-6">
            AirNode Alliance
          </h1>
        ...
        <div className="container mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 text-center">
            <div>
              ...
              <div className="text-gray-300">Active AirNodes</div>
            </div>
            <div>
            ...
            <div>
              <div className="text-3xl font-bold text-white mb-2">19.8%</div>
              <div className="text-gray-300">Average ROI</div>
            </div>
            <div>
              <div className="text-3xl font-bold text-white mb-2">1,280+</div>
